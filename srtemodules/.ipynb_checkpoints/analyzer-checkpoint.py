...
def analyze(df):
    ...
    tm = srte.drop(['TA8', 'TA9', 'TA10', 'TA11', 'TA12',
                    'CM13', 'CM14', 'CM15', 'CM16',
                    'IF17', 'IF18', 'IF19', 'IF20', 'IF21',
                    'PTA22', 'PTA23'], axis='columns'
                   )

    ta = srte.drop(['TM1', 'TM2', 'TM3', 'TM4', 'TM5', 'TM6', 'TM7',
                    'CM13', 'CM14', 'CM15', 'CM16',
                    'IF17', 'IF18', 'IF19', 'IF20', 'IF21',
                    'PTA22', 'PTA23'], axis='columns'
                   )

    cm = srte.drop(['TM1', 'TM2', 'TM3', 'TM4', 'TM5', 'TM6', 'TM7',
                    'TA8', 'TA9', 'TA10', 'TA11', 'TA12',
                    'IF17', 'IF18', 'IF19', 'IF20', 'IF21',
                    'PTA22', 'PTA23'], axis='columns'
                   )

    ifs = srte.drop(['TM1', 'TM2', 'TM3', 'TM4', 'TM5', 'TM6', 'TM7',
                     'TA8', 'TA9', 'TA10', 'TA11', 'TA12',
                     'CM13', 'CM14', 'CM15', 'CM16',
                     'PTA22', 'PTA23'], axis='columns'
                    )

    pta = srte.drop(['TM1', 'TM2', 'TM3', 'TM4', 'TM5', 'TM6', 'TM7',
                     'TA8', 'TA9', 'TA10', 'TA11', 'TA12',
                     'CM13', 'CM14', 'CM15', 'CM16',
                     'IF17', 'IF18', 'IF19', 'IF20', 'IF21'], axis='columns'
                    )

    tm = tm.groupby(['Course Title', 'Lecturer Name']).mean()
    tm['TM Overall'] = tm.apply(np.mean, axis=1)
    tm['TM Overall'] = tm['TM Overall'].round(1)
    tm['TM %'] = (tm['TM Overall']/5)*100
    tm['TM %'] = tm['TM %'].round(1)
    tm = tm.drop(['TM1', 'TM2', 'TM3', 'TM4', 'TM5',
                  'TM6', 'TM7'], axis='columns')

    ta = ta.groupby(['Course Title', 'Lecturer Name']).mean()
    ta['TA Overall'] = ta.apply(np.mean, axis=1)
    ta['TA Overall'] = ta['TA Overall'].round(1)
    ...
    cm['CM Overall'] = cm['CM Overall'].round(1)
    ...
    ifs['IF Overall'] = ifs['IF Overall'].round(1)
    ...
    pta['PTA Overall'] = pta['PTA Overall'].round(1)
    pta['PTA %'] = (pta['PTA Overall']/5)*100
    pta['PTA %'] = pta['PTA %'].round(1)
    pta = pta.drop(['PTA22', 'PTA23'], axis='columns')

    ts = ((tm['TM Overall']+ta['TA Overall']+cm['CM Overall'] +
           ifs['IF Overall']+pta['PTA Overall'])/5)
    tsp = (ts/5)*100
    pta['ES Overall'] = ts
    pta['ES Overall'] = pta['ES Overall'].round(1)
    pta['ES %'] = tsp
    ...
    def analyse_comp():
        sms = result[(result.index.str.startswith('ACCT')) |
        ...
        vasss = result[(result.index.str.startswith('ECON')) |
        ...
        cffs = result[(result.index.str.startswith('MAT')) |
        ...
        eah = result[(result.index.str.startswith('BEDU')) |
        ...
        pah = result[(result.index.str.startswith('MLSC')) |
        ...
        ces = result[(result.index.str.startswith('COSC')) |
        ...
        sat = result[(result.index.str.startswith('AGRE')) |
        ...
        bcsm = result[(result.index.str.startswith('ANAT')) |
        ...
        sbms = result[(result.index.str.startswith('COMH')) |
